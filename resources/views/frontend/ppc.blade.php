...
<section class="service_s2">
    <div class="service_c2">
        ...
        <img class="seo_s2img mobile_none" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s2img.png')  }}">
        <img class="seo_s2img desktop_none" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s2imgmob.png')  }}">
        ...
        <div class="service_s3cardbar">
            <div class="service_s3card service_s3card1">
                <div class="service_s3cardinner">
                    <img class="service_s3cardicon" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s3card1.svg')  }}">
                    <p class="service_s3cardtext">Monthly<br>Reports</p>
                </div>
            </div>
            <div class="service_s3card service_s3card2">
                <div class="service_s3cardinner">
                    <img class="service_s3cardicon" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s3card2.svg')  }}">
                    <p class="service_s3cardtext">Google Ads<br>Account</p>
                </div>
            </div>
            <div class="service_s3card service_s3card3">
                <div class="service_s3cardinner">
                    <img class="service_s3cardicon" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s3card3.svg')  }}">
                    <p class="service_s3cardtext">Unlimited<br>Changes</p>
                </div>
            </div>
            <div class="service_s3card service_s3card4">
                <div class="service_s3cardinner">
                    <img class="service_s3cardicon" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s3card4.svg')  }}">
                    <p class="service_s3cardtext">Keyword<br>Diagnostic</p>
                </div>
            </div>
        </div>
        <button type="button" class="btn service_s3btn"onclick="document.getElementById('features').scrollIntoView({ behavior: 'smooth' });">Explore More Features</button>
    </div>
</section>
...
<section class="service_s5">
    <div class="service_c5">
        ...
        <img class="service_s5img mobile_none" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s5img.png')  }}">
        <img class="service_s5img desktop_none" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s5imgmob.png')  }}">
...
<section class="service_s6"id="pricing">
    <div class="service_s6topbar">
        <img class="mobile_none" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s6img.png')  }}">
        <img class="desktop_none" src="{{ asset('frontend/Brandflaire/assest/images/ppc_s6imgmob.png')  }}">
                            ...
                            <div class="service_tabcontent table-responsive">
                                <table class="table table-borderless mb-0 service_table table-striped">
                                    ...
                                    <tbody class="service_table_body">
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">Unlimited adjustments</p>
                                            </td>
                                            @foreach ($ppcProducts['1_month'] as $product)
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">Keyword Diagnostic</p>
                                            </td>
                                            @foreach ($ppcProducts['1_month'] as $product)
                                            <td class="text-center">
                                                <img class="img-fluid"
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">Google Ads Account</p>
                                            </td>
                                            @foreach ($ppcProducts['1_month'] as $product)
                                            <td class="text-center">
                                                <img class="img-fluid"
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">monthly analysis (Bids)</p>
                                            </td>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">Creation of Ad Groups</p>
                                            </td>
                                            @foreach ($ppcProducts['1_month'] as $key => $product)
                                            <td class="text-center">
                                                @if ($key == 0)
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">display advertising creation</p>
                                            </td>
                                            @foreach ($ppcProducts['1_month'] as $key => $product)
                                            <td class="text-center">
                                                @if ($key < 2) <img class="img-fluid" src="">
                                                    @else
                                                    <img class="img-fluid"
                                                        src="{{ asset('frontend/Brandflaire/assest/images/service_tabletick.svg') }}">
                                                    @endif
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">competitor keyword tracker</p>
                                            </td>
                                            @foreach ($ppcProducts['1_month'] as $key => $product)
                                            <td class="text-center">
                                                @if ($key < 2) <img class="img-fluid" src="">
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-first">
                                                <p class="service_table_bodytext">reporting</p>
                                            </td>
                                            @foreach ($ppcProducts['1_month'] as $product)
                                            <td class="text-center">
                                                <p class="service_table_bodytext">Monthly</p>
                                            </td>
                                            @endforeach
                                        </tr>
                                        <tr class="align-middle">
                                ...
                                <table class="table table-borderless mb-0 service_table table-striped">
                                    ...
                                    <tbody class="service_table_body">
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            @foreach ($ppcProducts['3_months'] as $product)
                                            <td class="text-center service_table_bodysecondlast">
                                                <p class="service_table_bodyprice">{{ currency_symbol() }}{{ round(convert_price($product->unit_price), 2) }}
                                                </p>
                                            </td>
                                            @endforeach
