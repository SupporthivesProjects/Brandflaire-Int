...
<section class="termsection legalsection">
    <img src="{{ asset('frontend/Brandflaire/assest/images/pp-Voortman.png')}}" alt="" class="img-fluid bg-image d-md-block d-lg-block d-none">
    <img src="{{ asset('frontend/Brandflaire/assest/images/pp-Voortman-mo.png')}}" alt="" class="img-fluid bg-image d-md-none d-lg-none d-block">
    <div class="container">
        <div class="col">
            <div class="row">
...
<section class="legal-content-main">
    <img src="{{ asset('frontend/Brandflaire/assest/images/legalbg.png')}}" alt="" class="img-fluid bg-image d-md-block d-lg-block d-none">
    <div class="container">
        <div class="col">
            <div class="row">
